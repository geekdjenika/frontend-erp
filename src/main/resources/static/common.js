...
/***/ 2297:
/*!****************************************************************!*\
  !*** ./src/app/services/ForgetPass/forget-password.service.ts ***!
  \****************************************************************/
...
let ForgetPasswordService = class ForgetPasswordService {
    ...
    ChangePass(email, password, code) {
        const data = new FormData();
        const user = [
            {
                "email": email,
...
ForgetPasswordService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/***/ 1859:
/*!************************************************************!*\
  !*** ./src/app/services/acceuil/accueilservice.service.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AccueilserviceService": () => (/* binding */ AccueilserviceService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ 8784);
...
let AccueilserviceService = class AccueilserviceService {
    constructor(http) {
        this.http = http;
        this.env = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment;
    }
    GetActviteTotal(login, password) {
        const data = new FormData();
    ...
    GetToutesActivites(login, password) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
        data.append('user', JSON.stringify(user).slice(1, JSON.stringify(user).lastIndexOf(']')));
        return this.http.post(`${this.env.api}/utilisateur/totalactivite`, data);
    ...
    // :::::::::::::::::::::::activites en cours
    GetActiviteEncour(login, password) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
        data.append('user', JSON.stringify(user).slice(1, JSON.stringify(user).lastIndexOf(']')));
    ...
    //;:::::::::::::::::::TOTAL POSTULANT::::::::::::::::
    GetParticipantTotal(login, password) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
        data.append('user', JSON.stringify(user).slice(1, JSON.stringify(user).lastIndexOf(']')));
    ...
    participantFeminins(login, password) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
        data.append('user', JSON.stringify(user).slice(1, JSON.stringify(user).lastIndexOf(']')));
        //return this.http.post(`${this.env.api}/admin/getUsers/active`, data);
    ...
    participantEnfants(login, password) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
        data.append('user', JSON.stringify(user).slice(1, JSON.stringify(user).lastIndexOf(']')));
        //return this.http.post(`${this.env.api}/admin/getUsers/active`, data);
...
AccueilserviceService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
AccueilserviceService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], AccueilserviceService);
...
let RoleService = class RoleService {
    ...
    getListeFormatMail(login, password) {
        const data = new FormData();
        const user = [
            {
                "login": login,
    ...
    postRole(login, password, libellerole, droitRole) {
        const data = new FormData();
        const user = [
            {
                "login": login,
    ...
    deleteRole(login, password, idrole) {
        const data = new FormData();
        const user = [
            {
                "login": login,
    ...
    updateRole(login, password, libellerole, droitRole, idrole) {
        const data = new FormData();
        const role = [
            {
                "droits": droitRole,
...
/***/ 6266:
/*!***************************************************!*\
  !*** ./src/app/services/statut/status.service.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
StatusService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], StatusService);
...
/***/ 5399:
/*!***********************************************************************!*\
  !*** ./src/app/services/tahedesignations/tachedesignation.service.ts ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TachedesignationService": () => (/* binding */ TachedesignationService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ 8784);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 3184);
...
let TachedesignationService = class TachedesignationService {
    constructor(http) {
        this.http = http;
        this.env = src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment;
    }
    CreateTache(login, password, taches) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
        console.log(taches);
        data.append('user', JSON.stringify(user).slice(1, JSON.stringify(user).lastIndexOf(']')));
    ...
    //;;;;;;;;;;;;;;;;;;;;;;creer designation::::::::::::::::::::
    creerDesignation(login, password, libelle) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
    ...
    RecupTacheById(login, password, id) {
        const data = new FormData();
        const user = [{ "login": login, "password": password }];
        data.append('user', JSON.stringify(user).slice(1, JSON.stringify(user).lastIndexOf(']')));
...
TachedesignationService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
TachedesignationService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
        providedIn: 'root'
    })
], TachedesignationService);
...
/* harmony export */ });
/* harmony import */ var C_Users_djeni_IdeaProjects_Frontend_src_main_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_djeni_IdeaProjects_Frontend_src_main_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_djeni_IdeaProjects_Frontend_src_main_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_djeni_IdeaProjects_Frontend_src_main_ui_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_2914b3be_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
